        ...
        <div className="bg-[#F9F9F7] font-lato text-[#111111]">
            ...
            <section className="relative h-[90vh] flex items-center pt-20 overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <img src="https://images.stockcake.com/public/e/6/e/e6e4865c-08b7-4633-b428-f5658462485e_large/farmers-tending-crops-stockcake.jpg" className="w-full h-full object-cover" alt="African Farming" />
